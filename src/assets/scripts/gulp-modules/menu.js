!(function() {
   ...
   */ var r,
          ...
          if (!w) {
            ...
            'random' === i && oe(w),
              ...
              (w.v = x =
                (parseFloat(e.amount) ||
                  parseFloat(e.each) *
                    (T > x ? x - 1 : u ? ('y' === u ? x / T : T) : Math.max(T, x / T)) ||
                  0) * ('edges' === i ? -1 : 1)),
              (w.b = x < 0 ? n - x : n),
      ...
      var e = (t = (!t.name && t.default) || t).name,
        ...
        i =
          e && !r && t.init
            ...
            : t,
        n = { init: ht, render: or, add: We, kill: hr, modifier: ur, rawVars: 0 },
        ...
        if ((',' === t.substr(-1) && (t = t.substr(0, t.length - 1)), Te[t])) p = Te[t];
          ...
          if (
            (t.length < 6 &&
              ...
              (s = t.charAt(3)),
              (t =
                '#' + i + i + n + n + s + s + (5 === t.length ? t.charAt(4) + t.charAt(4) : ''))),
            9 === t.length)
          )
            return [
    ...
    ke = function(t) {
      ...
      if (((Oe.lastIndex = 0), Oe.test(r)))
        return (e = De.test(r)), (t[1] = Me(t[1], e)), (t[0] = Me(t[0], e, be(t[1]))), !0;
    },
    Ae =
      ((g = Date.now),
      (v = 500),
    ...
    Be = function(t, e, r, i) {
      ...
      return (
        xt(t, function(t) {
          for (var e in ((Se[t] = it[t] = s), (Se[(n = t.toLowerCase())] = r), s))
            Se[n + ('easeIn' === e ? '.in' : 'easeOut' === e ? '.out' : '.inOut')] = Se[
              t + '.' + e
            ] = s[e];
        }),
        s
                ...
                t
                  ...
                  : (Ce(),
                    ...
                    this.totalTime(
                      ...
                      1 === this.progress() && (this._tTime -= z) && Math.abs(this._zTime) !== z,
                    ))),
              this)
            : this._ps;
        }),
      ...
      (s.render = function(t, e, r) {
        ...
        if (y !== this._tTime || r || T) {
          if (
            ...
            if (((_ = this._yoyo), (u = v + this._rDelay), this._repeat < -1 && t < 0))
    ...
    Je = (function(n) {
      function s(e, s, a, o) {
        ...
        return (
          ...
          s.paused && u.paused(!0),
          (T ||
            (!v && !b && u._start === wt(k._time) && j(T) && Lt(t(u)) && 'nested' !== k.data)) &&
  ...
  var gr,
      ...
      return (
        ...
        Mr[e] && 'transform' !== e
          ...
          : (!(n = t.style[e]) || 'auto' === n || i || ~(n + '').indexOf('calc(')) &&
            (n = (hi[e] && hi[e](t, e, r)) || Gr(t, e) || Tt(t, e) || ('opacity' === e ? 1 : 0)),
    ...
    oi = { top: '0%', bottom: '100%', left: '0%', right: '100%', center: '50%' },
    ui = function(t, e) {
      if (e.tween && e.tween._time === e.tween._dur) {
        ...
        if ('all' === o || !0 === o) (a.cssText = ''), (i = 1);
          ...
          for (n = (o = o.split(',')).length; --n > -1; )
            (r = o[n]), Mr[r] && ((i = 1), (r = 'transformOrigin' === r ? jr : Vr)), ei(s, r);
    ...
    mi = function(t, e) {
      ...
      return (
        ...
        (m = _i(t, r.svg)),
        r.svg &&
          ((D = (!r.uncache || '0px 0px' === Y) && !e && t.getAttribute('data-svg-origin')),
    ...
    Oi = function(t, e, r, i, n, s) {
      ...
      return (
        h &&
          ('short' === (a = n.split('_')[1]) && (f %= u) !== f % 180 && (f += f < 0 ? u : -360),
          'cw' === a && f < 0
            ? (f = ((f + 36e9) % u) - ~~(f / u) * u)
        ...
        for (f in (Tr || Zr(), e))
          if ('autoRound' !== f && ((a = e[f]), !pt[f] || !Ge(f, e, r, i, t, n)))
            if (
              ...
              if (
                (D && f in D
                  ? ((s = 'function' == typeof D[f] ? D[f].call(r, i, t, n) : D[f]),
                ...
                f in Pr &&
                  ('autoAlpha' === f &&
                    (1 === u && 'hidden' === si(t, 'visibility') && o && (u = 0),
                    ri(
                      this,
                      O,
                      'visibility',
              ...
              if (d || ((o || 0 === o) && (u || 0 === u) && !Sr.test(a) && f in O))
                o || (o = 0),
                  ...
                  (this._pt = new cr(
                    ...
                    u,
                    _ ? _ * o : o - u,
                    d || ('px' !== p && 'zIndex' !== f) || !1 === e.autoRound ? Er : Rr,
                  )),
                  (this._pt.u = p || 0),
